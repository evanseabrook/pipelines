...
def upload_model(
  ...
  # Add explanation_spec details back into the request, as sklearn/xgboost input features can be empty.
  if ('explanation_spec' in model_spec) and ('metadata' in model_spec['explanation_spec']):
